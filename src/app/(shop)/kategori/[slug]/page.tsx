      ...
      <section className="relative overflow-hidden rounded-xl border border-line bg-plum-950">
        ...
        <div className="relative px-6 py-14 sm:px-10 sm:py-20">
          ...
          <p className="tabular mt-3 text-sm text-white/70">
            {category.products.length} ürün · onaylı çiçekçilerden
          </p>
        </div>
      </section>
      ...
      <div className="mt-4">
        {category.products.length === 0 ? (
          <EmptyState
            ...
            description="Çiçekçiler bu kategoriye ürün eklediğinde burada görünecek."
            action={{ href: "/urunler", label: "Tüm ürünlere bak" }}
          />
        ) : (
